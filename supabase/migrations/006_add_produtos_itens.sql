...
-- Garante que alterações futuras no catálogo não afetam pedidos antigos
create table if not exists itens_pedido (
  ...
  unidade_medida text not null check (unidade_medida in ('peso_kg', 'cento', 'unidade')),
  preco_unitario numeric(10,4) not null, -- snapshot do preço no momento da venda
  quantidade numeric(10,4) not null,    -- decimal para peso_kg/cento, inteiro para unidade
